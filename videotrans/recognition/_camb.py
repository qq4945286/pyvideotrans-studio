        ...
        try:
            ...
            while elapsed < max_wait:
                ...
                if status == "SUCCESS":
                    ...
                    err_msg = (
                        status_result.exception_reason
                        if hasattr(status_result, "exception_reason")
                        else status_result.get("exception_reason", "Unknown error")
                    )
            ...
            transcript = (
                ...
                if hasattr(transcription_result, "transcript")
                else transcription_result.get("transcript", [])
            )
            ...
            for entry in transcript:
                ...
                tmp = {"line": len(raws) + 1, "start_time": start_ms, "end_time": end_ms, "text": text.strip()}
