...
class AI302Recogn(BaseRecogn):
    ...
    def _exec(self) -> Union[List[Dict], None]:
        ...
        response = requests.post(
            ...
            data={"model": model_name, "response_format": "verbose_json", "prompt": prompt, "language": langcode},
            headers=headers,
        )
    ...
    def _thrid_api(self):
        ...
        for i, it in enumerate(raws):
            response = requests.post(
                ...
                data={"model": model_name, "response_format": "json", "prompt": prompt, "language": langcode},
                headers=headers,
            )
            ...
            raws.append(
                {
                    ...
                    "text": it["text"],
                    "time": tools.ms_to_time_string(ms=it["start"] * 1000)
                    + " --> "
                    + tools.ms_to_time_string(ms=it["end"] * 1000),
                }
            )
