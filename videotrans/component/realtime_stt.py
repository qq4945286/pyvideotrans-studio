...
class Worker(QThread):
    ...
    def run(self):
        ...
        mic_stream = sd.InputStream(device=self.device_idx, channels=1, dtype="float32", samplerate=self.sample_rate)
        mic_stream.start()
...
class RealTimeWindow(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle(
            tr("Real-time speech-to-text") + " " + tr("Only supports Chinese and English language recognition")
        )
