...
# 全局暗色主题 QSS 样式表
DARK_STYLE_QSS = ""
_qss_path = Path(f"{ROOT_DIR}/videotrans/styles/style.qss")
if _qss_path.exists():
    DARK_STYLE_QSS = _qss_path.read_text(encoding="utf-8")
...
def _set_logs():
    ...
    _file_handler = logging.FileHandler(
        f'{ROOT_DIR}/logs/{datetime.datetime.now().strftime("%Y%m%d")}.log', encoding="utf-8"
    )
...
class AppSettings:
    ...
    def _get_defaults(self) -> Dict:
        return {
            ...
            "comfyui_workflow": "",
            "t2v_tts_engine": "edgetts",
            "tts_voice": "zh-CN-YunjianNeural",
            "tts_speed": "1.2",
            "t2v_cosyvoice_role": "clone",
            "orientation": "landscape",
            "t2v_resolution": "1920x1080",
            "fps": "30",
