...
class Ui_f5ttsform(object):
    def setupUi(self, f5ttsform):
        ...
        self.req.setText(
            tr(
                "Reference audio needs to be in wav format, with a duration of no more than 12 seconds, and stored in the /f5-tts directory of this software"
            )
        )
    ...
    def retranslateUi(self, f5ttsform):
        ...
        self.f5tts_role.setPlaceholderText(tr("Reference Audio#Audio Text"))
