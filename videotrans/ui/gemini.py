...
class Ui_geminiform(object):
    def setupUi(self, geminiform):
        ...
        v1.addLayout(h3)
        self.gemini_template.setPlainText(
            tr("Prompt: Please open the {} file directly to modify it", "gemini", "gemini")
        )
    ...
    def retranslateUi(self):
        ...
        self.label_srt.setText(tr("Prompt for subtitles when converting audio to video"))
