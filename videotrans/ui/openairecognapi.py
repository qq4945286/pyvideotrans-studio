...
class Ui_openairecognapiform(object):
    def setupUi(self, openairecognapiform):
        ...
        self.label_0.setText(tr("AIs compatible with the ChatGPT also used here"))
    ...
    def retranslateUi(self, openairecognapiform):
        openairecognapiform.setWindowTitle(tr("OpenAI API Speech to text"))
        ...
        self.openairecognapi_url.setPlaceholderText(
            tr(
                "If using the official OpenAI interface, there is no need to fill it out; Fill in the third-party API here"
            )
        )
