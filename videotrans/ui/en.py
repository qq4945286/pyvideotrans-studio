...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.clear_cache.setToolTip(
            tr(
                "Cleaning up files that have been processed in previous executions, such as recognized or translated subtitle files"
            )
        )
        ...
        self.copysrt_rawvideo.setToolTip(
            tr(
                "When this item is checked, and the target language is different from the language of the pronunciation will move the translated srt file to the original video location and rename it to the same name as the video."
            )
        )
        ...
        self.shutdown.setToolTip(tr("Automatic shutdown after completing all tasks"))
        ...
        self.reglabel.setToolTip(tr("Click to set detailed recognition parameters when using faster-whisper"))
        ...
        self.label_9.setToolTip(tr("Click to set the number of subtitles to be translated at the same time"))
        ...
        self.translate_type.setToolTip(tr("Select the channel used to translate text"))
        ...
        self.tts_text.setToolTip(tr("Click to set the number of threads to be used for dubbing"))
        ...
        self.cjklinenums.setToolTip(tr("Chinese/Japanese/Korean line length"))
        ...
        self.label_othlinenums.setText(tr("Ohter Line length"))
        ...
        self.othlinenums.setToolTip(tr("Number of characters per line for subtitles in other languages"))
        ...
        self.threshold.setToolTip(tr("Threshold for speech detection"))
        ...
        self.min_speech_duration_ms_label.setText(tr("min_speech_duration_ms"))
        ...
        self.min_speech_duration_ms.setToolTip(tr("Minimum speech duration (ms)"))
        ...
        self.min_silence_duration_ms_label.setText(tr("min_silence_duration_ms"))
        ...
        self.min_silence_duration_ms.setToolTip(tr("Minimum silence duration (ms)"))
        ...
        self.max_speech_duration_s.setToolTip(tr("max speech duration (s)"))
