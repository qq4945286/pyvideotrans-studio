...
class Ui_subtitlescover(object):
    def setupUi(self, subtitlescover):
        ...
        self.formatlist.addItems(["srt", "ass", "vtt", "txt"])
        ...
        subtitlescover.setWindowTitle(tr("Convert subtitles between SRT/ASS/VTT/TXT formats"))
        self.retranslateUi()
        QtCore.QMetaObject.connectSlotsByName(subtitlescover)

    def retranslateUi(self):

        self.selectbtn.setText(tr("Select files to be converted/multiple selections possible"))

        self.labelformat.setText(tr("Target format"))

        self.pathdir.setPlaceholderText(tr("Select files to be converted/multiple selections possible"))
