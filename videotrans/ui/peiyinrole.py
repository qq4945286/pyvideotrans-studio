...
class Ui_peiyinrole(object):
    def setupUi(self, peiyinrole):
        ...
        if not peiyinrole.objectName():
            peiyinrole.setObjectName("peiyinrole")
        ...
        self.subtitle_table.setHorizontalHeaderLabels(
            [tr("Line"), tr("Sel"), tr("Time Axis"), tr("Dubbing role"), tr("Speaker"), "Text"]
        )
    ...
    def retranslateUi(self, peiyinrole):
        peiyinrole.setWindowTitle(tr("Subtitle multi-role dubbing: assign a voice to each subtitle"))
