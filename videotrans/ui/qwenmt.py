...
class Ui_qwenmtform(object):
    def setupUi(self, qwenmtform):
        ...
        self.label_0.setText(
            tr(
                "Configure Alibaba Bailian Qwen-MT model or other text models or Qwen3-ASR speech recognition model here"
            )
        )
        ...
        self.qwenmt_domains.setPlaceholderText(
            tr(
                "Fill in a natural language text (must be English) describing your domain, which will be provided to the model as a prompt"
            )
        )
        ...
        self.label_selectmodel.setText(
            tr("Subtitle translation model (must start with qwen-mt or other qwen text generation model)")
        )
