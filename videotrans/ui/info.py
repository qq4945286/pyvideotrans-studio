...
"""
            if defaulelang == "zh"
            else """This project is created based on interest, there is no commercial and no charge plan, you can use it for free or fork it and modify it (open source license GPL-v3). 
...
Documents: pyvideotrans.com"""
        ...
        if defaulelang == "zh":
            ...
            wxpaystask = DownloadImg(
                parent=self, urls={"name": "wxpay", "link": "https://pvtr2.pyvideotrans.com/images/wxpay.jpg"}
            )
            alipaytask = DownloadImg(
                parent=self, urls={"name": "alipay", "link": "https://pvtr2.pyvideotrans.com/images/alipay.png"}
            )
            mptask = DownloadImg(
                parent=self, urls={"name": "mp", "link": "https://pvtr2.pyvideotrans.com/images/mp.jpg"}
            )
