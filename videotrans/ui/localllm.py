...
class Ui_localllmform(object):
    def setupUi(self, localllmform):
        ...
        self.label_0.setText(tr("AIs compatible with the ChatGPT Local LLM also used here"))
        ...
        v1.addLayout(h4)
        self.localllm_template.setPlainText(
            tr("Prompt: Please open the {} file directly to modify it", "localllm", "localllm")
        )
    ...
    def retranslateUi(self, localllmform):
        ...
        self.localllm_api.setPlaceholderText(tr("Local LLM API url"))
