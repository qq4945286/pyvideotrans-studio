...
class Ui_recogn(object):
    def setupUi(self, recogn):
        ...
        self.spk_insert.setToolTip(
            tr(
                "If the selected channel supports speaker recognition, selecting this option will insert a speaker identifier at the beginning of the subtitles"
            )
        )
        ...
        self.speech_pad_ms.setToolTip(tr("Speech padding (ms)"))
        ...
        self.shibie_label.setToolTip(tr("Click to set detailed recognition parameters when using faster-whisper"))
        self.label_model.setText(tr("Select model"))

        self.lable_out.setText(tr("Subtitle format:"))
        self.out_format.addItems(["srt", "ass", "vtt", "txt"])
        ...
        self.copysrt_rawvideo.setToolTip(
            tr(
                "If selected, the subtitles will be saved to the original audio and video location and renamed to the same name as the original audio and video"
            )
        )
