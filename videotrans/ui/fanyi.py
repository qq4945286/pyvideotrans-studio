...
class Ui_fanyisrt(object):
    def setupUi(self, fanyisrt):
        ...
        if not fanyisrt.objectName():
            fanyisrt.setObjectName("fanyisrt")
        ...
        self.out_format.addItems(
            [tr("Monolingual subtitles"), tr("Target language up(Bilingual)"), tr("Target language under(Bilingual)")]
        )
    ...
    def retranslateUi(self):
        ...
        self.fanyi_proxy.setPlaceholderText(tr("Failed to access Google services. Please set up the proxy correctly"))
