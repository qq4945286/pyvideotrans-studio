    ...
    def setupUi(self, setini):
        ...
        self.notices = {
            ...
            "video": {
                ...
                "hw_decode": "最后一步视频合成时，强制使用GPU(cuda/rocm)解码视频，更快但易出错",
            ...
            "whisper": {
                ...
                "cuda_com_type": "faster模式时GPU(CUDA/ROCm)数据类型，int8=消耗资源少，速度快，精度低，float32=消耗资源多，速度慢，精度高，float16适合GPU加速。default默认自选",
        ...
        self.titles = {
            ...
            "hw_decode": "视频合成GPU硬解码(cuda/rocm)",
            "normal_text": "文本规范化",
            "uvr_models": "分离背景声模型",
        ...
        if defaulelang != "zh":
            ...
            self.titles = {
                ...
                "hw_decode": "ffmpeg decode video use GPU (cuda/rocm)",
                ...
                "cuda_com_type": "GPU compute type (CUDA/ROCm)",
        ...
        label_title.setText(tr("Clicking  title on the left will show help"))
            ...
            for key, tips_str in item.items():
                ...
                if key == "homedir":
                    ...
                    self.homedir_btn.setToolTip(
                        tr(
                            "Click on Set Home Directory to save the result files for video separation, subtitle translation, subtitle dubbing, etc."
                        )
                    )
