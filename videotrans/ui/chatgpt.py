...
class Ui_chatgptform(object):
    def setupUi(self, chatgptform):
        ...
        self.label_0.setText(tr("AIs compatible with the ChatGPT also used here(For LLM re-segment)"))
        ...
        v1.addLayout(h4)
        self.chatgpt_template.setPlainText(
            tr("Prompt: Please open the {} file directly to modify it", "chatgpt", "chatgpt")
        )
    ...
    def retranslateUi(self, chatgptform):
        ...
        self.chatgpt_key.setToolTip(tr("Must be a paid account, free account frequency is limited and cannot be used"))
