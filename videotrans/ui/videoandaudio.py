...
from PySide6.QtWidgets import QHBoxLayout, QLabel, QLineEdit, QPushButton, QVBoxLayout, QCheckBox
...
class Ui_videoandaudio(object):
    def setupUi(self, videoandaudio):
        ...
        if not videoandaudio.objectName():
            videoandaudio.setObjectName("videoandaudio")
        ...
        self.audio_process.addItems([tr("Truncate"), tr("Auto Accelerate")])
    ...
    def retranslateUi(self):
        self.folder.setPlaceholderText(tr("Select the folder where you want to merge the video and audio"))
        ...
        self.labeltips.setText(tr("Will merge video and audio with the same name in that folder, e.g. 1.mp4 and 1.wav"))
