...
class Ui_ai302form(object):
    def setupUi(self, ai302form):
        ...
        self.label_1.setText(
            tr(
                "Has been connected to the text model translation subtitles and speech recognition and openai/doubao/Azure/Minimaxi/Dubbingx dubbing characters"
            )
        )
    ...
    def update_ui(self):
        ...
        self.ai302_model_recogn.addItems(
