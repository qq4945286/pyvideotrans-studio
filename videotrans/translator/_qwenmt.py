...
class QwenMT(BaseTrans):
    ...
    def _item_task(self, data: Union[List[str], str]) -> str:
        ...
        if model_name.startswith("qwen-mt"):
            ...
            translation_options = {"source_lang": "auto", "target_lang": self.target_language_name}
            # 术语表
        ...
        self.prompt = tools.get_prompt(ainame="bailian", aisendsrt=self.aisendsrt).replace(
