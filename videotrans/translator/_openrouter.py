...
class OpenRouter(BaseTrans):
    ...
    def __post_init__(self):
        ...
        self.prompt = tools.get_prompt(ainame="openrouter", aisendsrt=self.aisendsrt).replace(
    ...
    def _item_task(self, data: Union[List[str], str]) -> str:
        ...
        model = OpenAI(
            api_key=self.api_key, base_url=self.api_url, http_client=httpx.Client(proxy=self.proxy_str, timeout=7200)
        )
