...
class HuoShan(BaseTrans):
    ...
    def __post_init__(self):
        ...
        self.prompt = tools.get_prompt(ainame="zijie", aisendsrt=self.aisendsrt).replace(
    ...
    def _item_task(self, data: Union[List[str], str]) -> str:
        ...
        client = OpenAI(base_url="https://ark.cn-beijing.volces.com/api/v3", api_key=params.get("zijiehuoshan_key", ""))
        ...
        try:
            ...
            match = re.search(
                ...
                re.sub(r"<think>(.*?)</think>", "", result, flags=re.I | re.S),
                flags=re.S | re.I,
            )
            if match:
