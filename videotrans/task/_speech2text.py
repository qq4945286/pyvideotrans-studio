    ...
    def recogn(self):
        ...
        try:
            ...
            if self.cfg.recogn_type == Faster_Whisper_XXL:
                cmd = [settings.get("Faster_Whisper_XXL", ""), self.cfg.shibie_audio, "-pp", "-f", "srt"]
                ...
                cmd = [cpp_path, "-f", self.cfg.shibie_audio, "-osrt", "-np"]
            ...
            if self._exit() or self.cfg.detect_language == "auto":
                return
    ...
    def task_done(self):
        ...
        if self.cfg.detect_language and self.cfg.detect_language != "auto":
            ...
            maxlen = int(
                ...
                if self.cfg.detect_language[:2] in ["zh", "ja", "jp", "ko", "yu"]
        ...
        if (
            self.cfg.enable_diariz
            and params.get("stt_spk_insert")
            and Path(self.cfg.cache_folder + "/speaker.json").exists()
        ):
